<template>
  <div class="d-flex flex-column">
    <EquipmentGroup v-for="(division, index) in divisions" :key="index" :title="division" :data="getEquipmentsByDivision(division)" :editFunction="editFunction" :deleteFunction="deleteFunction" />
  </div>
</template>
